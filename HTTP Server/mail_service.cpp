...
void *mailWorker(void *comm_fd)
{
    ...
    const char *SERVICE_ERR = "421 localhost Service not available, closing transmission channel\r\n";
    const char *UNKNOWN = "500 Syntax error, command unrecognized [This may include errors such as command line too long]\r\n";
